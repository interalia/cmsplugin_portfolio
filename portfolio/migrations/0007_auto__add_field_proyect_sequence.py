...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Proyect.sequence'
        db.add_column('portafolio_proyect', 'sequence', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Proyect.sequence'
        db.delete_column('portafolio_proyect', 'sequence')
