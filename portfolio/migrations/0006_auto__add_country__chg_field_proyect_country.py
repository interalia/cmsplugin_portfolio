...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('portafolio_country', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('portafolio', ['Country'])

        # Renaming column for 'Proyect.country' to match new field type.
        db.rename_column('portafolio_proyect', 'country', 'country_id')
        # Changing field 'Proyect.country'
        db.alter_column('portafolio_proyect', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portafolio.Country']))

        # Adding index on 'Proyect', fields ['country']
        db.create_index('portafolio_proyect', ['country_id'])


    def backwards(self, orm):
        
        # Removing index on 'Proyect', fields ['country']
        db.delete_index('portafolio_proyect', ['country_id'])

        # Deleting model 'Country'
        db.delete_table('portafolio_country')

        # Renaming column for 'Proyect.country' to match new field type.
        db.rename_column('portafolio_proyect', 'country_id', 'country')
        # Changing field 'Proyect.country'
        db.alter_column('portafolio_proyect', 'country', self.gf('django_countries.fields.CountryField')(max_length=2))
