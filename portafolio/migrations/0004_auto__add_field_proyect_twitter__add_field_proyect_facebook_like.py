...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Proyect.twitter'
        db.add_column('portafolio_proyect', 'twitter', self.gf('django.db.models.fields.CharField')(default='@dw_interalia', max_length=20), keep_default=False)

        # Adding field 'Proyect.facebook_like'
        db.add_column('portafolio_proyect', 'facebook_like', self.gf('django.db.models.fields.URLField')(default='http://facebook.com/interalia.net', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Proyect.twitter'
        db.delete_column('portafolio_proyect', 'twitter')

        # Deleting field 'Proyect.facebook_like'
        db.delete_column('portafolio_proyect', 'facebook_like')
    ...
    models = {
        ...
        'portafolio.proyect': {
            ...
            'facebook_like': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
